...
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/Azure-Samples/application-health-samples/main/Binary%20Health%20States/powershell-demo/application.ps1" -OutFile $applicationPath
